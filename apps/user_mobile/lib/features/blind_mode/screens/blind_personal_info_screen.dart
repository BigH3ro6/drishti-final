...
class BlindPersonalInfoScreen extends StatelessWidget {
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                _buildField("Full Name", "Kamal Perera"),
                const SizedBox(height: 20),
                _buildField("Phone Number", "+94 71 234 5678"),
                const SizedBox(height: 20),
                _buildField("Medical Notes", "Diabetic, Mild Hearing Loss in left ear."),
                const Spacer(),
                ElevatedButton(
                  onPressed: () {},
